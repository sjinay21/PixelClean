...
//import AnalysisPanel from "@/analyzer/AnalysisPanel"; // panel import
...
export default function WatermarkTool() {
  ...
  //const [analysis, setAnalysis] = useState(null); // analysis state
  ...
  const handleAction = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://pixelclean.onrender.com/api/watermark",
        {
          method: "POST",
          headers: {
      ...
      /*// update analysis if backend sends extra data
      if (data.analysis) {
        setAnalysis(prev => ({
          ...prev,
          ...data.analysis
...
a.download = `watermark-${timestamp}.png`;
      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 max-w-2xl mx-auto">
          ...
          <input
            ...
            // 🔥 ADDED: create analysis when file is chosen
            onChange={(e) => {
